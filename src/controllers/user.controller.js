...
const getUserChannelProfile = asyncHandler(async (req, res) => {
  ...
  if (!userName.trim()) {
    throw new ApiError(400, "User name is mandatory");
  }
  // User.find({ userName });
  // Can apply direct agrregation pipeline
    ...
    },
    {
      $addFields: {
        totalSubscribersCount: {
          $size: "$subscribers",
        }, //Count how many subscribers are there
        chaneelsSubscribedToCount: {
          $size: "$subscribedTo",
        }, //will count how many chennle I've subscribed
        isSubscribed: {
          $cond: {
            $in: {
              ...
              pipeline: [
                {
                  $project: {
                    ...
                    userName: 1,
                    avatar: 1,
                  }, //It will everything required field inside owner field
                },
              ],
            },
